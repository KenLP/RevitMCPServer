#!/usr/bin/env node
/**
 * Revit MCP Server v0.8.18 (stdio).
 *
...
const server = new McpServer({ name: "revit-mcp-server", version: "0.8.18" });
...
async function main() {
  ...
  console.error(`[revit-mcp-server] v0.8.18 connected to Revit addin at ${REVIT_BASE_URL}`);
