#!/usr/bin/env node
/**
 * Revit MCP Server v0.8.19 (stdio).
 *
...
const server = new McpServer({ name: "revit-mcp-server", version: "0.8.19" });
...
async function main() {
  ...
  console.error(`[revit-mcp-server] v0.8.19 connected to Revit addin at ${REVIT_BASE_URL}`);
