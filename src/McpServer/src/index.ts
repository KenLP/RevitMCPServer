...
const server = new McpServer({ name: "revit-mcp-server", version: "0.4.0" });
...
async function main() {
  ...
  console.error(`[revit-mcp-server] v0.4.0 connected to Revit addin at ${REVIT_BASE_URL}`);
}
