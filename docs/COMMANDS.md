...
> **v0.8.35 — 91 commands + 1 batch + 2 recipes = 94 MCP tools** (10 hidden: `create_spot_elevation` + the 9-command spatial-QC HTTP pack `spatial_*`; 101 C# commands registered; workflow recipes are Node-only).
>
