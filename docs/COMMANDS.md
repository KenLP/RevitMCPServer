...
> **v0.8.28 — 90 commands + 1 batch + 2 recipes = 93 MCP tools** (9 hidden: `create_spot_elevation` + the 8-command spatial-QC HTTP pack `spatial_*`; 99 C# commands registered; workflow recipes are Node-only).
>
