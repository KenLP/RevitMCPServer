...
> **v0.8.17 — 86 commands + 1 batch + 2 recipes = 89 MCP tools** (5 hidden: `create_spot_elevation` + the 4-command spatial-QC HTTP pack `spatial_*`; 91 C# commands registered; workflow recipes are Node-only).
>
